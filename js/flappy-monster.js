...
FlappyMonster.prototype.createObjects = function() {
  ...
  // Background
  game.background1 = new GameBackground('images/resi.png', game.canvas);
  game.background2 = new GameBackground('images/resi.png', game.canvas);
  ...
  // Monster
  game.monster = new Monster('images/fifth.png', game.canvas);
...
FlappyMonster.prototype.drawInitialScreen = function() {
  ...
  game.context.fillText('Click para drogarte!', game.canvas.width / 2 - 100, game.canvas.height / 2);
};
...
FlappyMonster.prototype.drawGameOverScreen = function() {
  ...
  game.context.fillText('Tu puntaje es : ' + game.gameScore.score, game.canvas.width / 2 - 180, game.canvas.height / 2 - 100);
  game.context.font = '36px Arial';
  game.context.fillText('Perdiste drogadicto :(', game.canvas.width / 2 - 100, game.canvas.height / 2);
  game.context.font = '24px Arial';
  game.context.fillText('Presiona R para volver a intentar!', game.canvas.width / 2 - 100, game.canvas.height / 2 + 50);
};
